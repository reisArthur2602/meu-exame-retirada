...
export default function UploadForm() {
    const [submitted, setSubmitted] = useState<{ nome: string; cpf: string; telefone: string } | null>(null);
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
                <div className="flex flex-col items-center text-center mb-6">
                    ...
                    <p className="text-sm text-slate-500">
                        O laudo de{' '}
                        <span className="font-semibold text-slate-700">{submitted.nome}</span>{' '}
                        já está disponível para o paciente.
                    </p>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-3 mb-6">
                    <button
                        onClick={() => openWhatsApp(submitted.telefone, buildWhatsAppMessage(firstName, ''))}
                        disabled={!hasPhone}
